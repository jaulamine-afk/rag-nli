...
6. **Statistical Consistency:**
   - Across 21 different configurations (3 models × 3 Top-K × 3 pipelines)
   - Sub-Claims consistently ranks as best or second-best
   - Clear evidence that the approach is not model-specific but methodologically sound

---

## Recommendations

✅ **Use FLAN-T5-Base + RAG + NLI + Sub-Claims with Top-4** for:
- Best overall performance (EM: 0.33, F1: 0.436)
- Complex questions requiring multiple pieces of evidence

✅ **Use FLAN-T5-Base + RAG Baseline with Top-2** for:
- Speed-critical applications
- Simple factual questions
- When performance of 0.29 EM is acceptable

✅ **Use FLAN-T5-Small + RAG + NLI + Sub-Claims with Top-2** for:
- Resource-constrained environments
- Good balance of speed and quality (EM: 0.29, F1: 0.412)

❌ **Avoid:**
- UnifiedQA-T5-Small for this task (significantly underperforms)
- Top-K > 4 (performance degrades)
